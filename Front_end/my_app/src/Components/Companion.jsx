...
function Companion() {
  ...
  return (
    <div className="companion-container">
      <p className="companion-title">Companion Care &gt; <span>Search</span></p>
      <p className="companion-search-prompt">Please enter a search keyword</p>
      ...
      <div className="companion-content">
        <div className="refine-container">
          ...
          <div className="checkbox-group">
            ...
            <div>
              <input type="checkbox" value="Dog" onChange={handleCheckboxChange} />
              <span>Dog</span>
            </div>
            <div>
              <input type="checkbox" value="Rabbit" onChange={handleCheckboxChange} />
              <span>Rabbit</span>
            </div>
            <div>
              <input type="checkbox" value="Bird" onChange={handleCheckboxChange} />
              <span>Bird</span>
            </div>
            <div>
              <input type="checkbox" value="Hamster" onChange={handleCheckboxChange} />
              <span>Hamster</span>
            </div>
            <div>
              <input type="checkbox" value="Fish" onChange={handleCheckboxChange} />
              <span>Fish</span>
            </div>
          </div>
        </div>
      ...
      <div className="pagination">
        ...
        <p>{pageNumber}</p>
        <button disabled={pageNumber === 5} onClick={() => setPageNumber(pageNumber + 1)}>Next</button>
      </div>
    </div>
  );
}
